...
<html lang="nl" dir="ltr">
  <head>
    ...
    <meta name="author" content="Reinier van der Velden">
    ...
    <link rel="stylesheet" href="/styles/mixins.min.css">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-121084372-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-121084372-1');
    </script>
  </head>
<body>
